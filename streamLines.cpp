...
void animate() {
	...
	p1[0] = p1[0] + 0.015;	// forward backward
	p1[1] = p1[1] + 0.005;	// left right
	//p1[2] = p1[2] - 0.005;	// rotate?
	p2[0] = p2[0] - 0.01;
	//p2[2] = p2[2] - 0.01;
	//for (int i = 0; i < 3; i++)
	//	t[i] = (p2[i] - p1[i]) / 2;
